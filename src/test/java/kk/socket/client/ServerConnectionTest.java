...
import kk.socket.engineio.client.transports.Polling;
import kk.socket.engineio.client.transports.WebSocket;
...
public class ServerConnectionTest extends Connection {
    ...
    public void closeEngineConnection() throws URISyntaxException, InterruptedException {
        ...
        socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                socket.io().engine.on(kk.socket.engineio.client.Socket.EVENT_CLOSE, new Emitter.Listener() {
                    @Override
                    public void call(Object... objects) {
                        values.offer("done");
                    }
