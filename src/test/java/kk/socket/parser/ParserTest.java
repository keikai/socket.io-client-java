...
public class ParserTest {
    ...
    public void encodeEvent() {
        ...
        packet1.data = (JSONArray) JSONValue.parse("[\"a\", 1, {}]");
        packet1.nsp = "/";
        Helpers.test(packet1);

        Packet<JSONArray> packet2 = new Packet<JSONArray>(Parser.EVENT);
        packet2.data = (JSONArray) JSONValue.parse("[\"a\", 1, {}]");
        packet2.nsp = "/test";
    ...
    public void encodeAck() {
        ...
        packet.data = (JSONArray) JSONValue.parse("[\"a\", 1, {}]");
        packet.id = 123;
        packet.nsp = "/";
        Helpers.test(packet);
    }
